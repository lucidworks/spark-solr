package com.lw.spark.example.query;

import com.lw.spark.util.SolrQuerySupport.PivotField;
...
public class KMeansAnomaly implements SparkApp.RDDProcessor {
  ...
  public int run(SparkConf conf, CommandLine cli) throws Exception {
    ...
    DataFrame solrDataWithPivots = (new SolrRDD(zkHost, collection)).withPivotFields(logEvents, pivotFields);
