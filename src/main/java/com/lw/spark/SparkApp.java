...
import com.lw.spark.example.events.Eventsim;
import com.lw.spark.example.hadoop.HdfsToSolrRDDProcessor;
import com.lw.spark.example.hadoop.Logs2SolrRDDProcessor;
import com.lw.spark.example.query.KMeansAnomaly;
import com.lw.spark.example.query.ReadTermVectors;
import com.lw.spark.example.query.SolrQueryProcessor;
import com.lw.spark.example.query.TableScanBenchmark;
import com.lw.spark.example.streaming.DocumentFilteringStreamProcessor;
import com.lw.spark.example.streaming.TwitterToSolrStreamProcessor;
