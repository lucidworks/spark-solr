...
|http://search.maven.org/#artifactdetails%7Ccom.lucidworks.spark%7Cspark-solr%7C3.5.1%7Cjar[3.5.1]  | 2.3.1 | 7.3.1
|http://search.maven.org/#artifactdetails%7Ccom.lucidworks.spark%7Cspark-solr%7C3.4.5%7Cjar[3.4.5]  | 2.2.1 | 7.2.1
...
[source]
cd $SPARK_HOME
./bin/spark-shell --jars spark-solr-3.5.1-shaded.jar
